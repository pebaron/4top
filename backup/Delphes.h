...
// Thu Feb 18 12:26:11 2021 by ROOT version 6.16/00
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxGenLJet = 17;
   static constexpr Int_t kMaxGenJet = 24;
   static constexpr Int_t kMaxGenElectron = 12;
   static constexpr Int_t kMaxGenMuon = 8;
   static constexpr Int_t kMaxGenTop = 88;
   static constexpr Int_t kMaxGenPhoton = 742;
   static constexpr Int_t kMaxGenMissingET = 1;
   static constexpr Int_t kMaxGenZPrime = 1;
   static constexpr Int_t kMaxGenW = 7;
   static constexpr Int_t kMaxGenBhadrons = 20;
   static constexpr Int_t kMaxJet = 22;
   static constexpr Int_t kMaxLJet = 17;
   static constexpr Int_t kMaxJetJES = 22;
   ...
   Delphes(TTree *tree=0, TString Input="input.root", TString NameOfTree="Delphes", TString PathToTree="");
   virtual ~Delphes();
